package com.example.jeffreywu.simplecalculator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddition.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((operand1.getText().length() > 0) && (operand2.getText().length() >
                        0)) {
                    ...
                    Toast.makeText(MainActivity.this, "Please enter number in both operand fields",
